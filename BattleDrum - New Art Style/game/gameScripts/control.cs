...
{	
	...
	moveMap.bindCmd(keyboard, "space", "playBlip(); ResetTime(); ResetCount(); $Sun.growSun();$Ta.showTa();$Don.showDon();$Pa.showPa();$Pon.showPon();", 
			"$Sun.backSun();$Ta.hideTa();$Don.hideDon();$Pa.hidePa();$Pon.hidePon();");
