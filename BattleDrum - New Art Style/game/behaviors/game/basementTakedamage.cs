...
if (!isObject(BasementTakesDamageAdvBehavior))
{
   %template = new BehaviorTemplate(BasementTakesDamageAdvBehavior);
   
   %template.friendlyName = "Basement Takes Damage";
...
function BasementTakesDamageAdvBehavior::onAddToScene(%this)
{
...
function BasementTakesDamageAdvBehavior::takeDamage(%this, %amount, %assailant)
{
   if (%this.invincible)
      return;
...
function BasementTakesDamageAdvBehavior::kill(%this)
{
   %this.lives--;
   if (%this.lives <= 0)
   {
      ...
      {
         schedule( 2000, 0, "BasementTakesDamageAdvBehavior_loadLevel", %this.nextLevel );
      }
...
function BasementTakesDamageAdvBehavior::setVincible(%this)
{
   %this.invincible = false;
}

function BasementTakesDamageAdvBehavior::spawn(%this)
{
...
function BasementTakesDamageAdvBehavior::explode(%this)
{
...
function BasementTakesDamageAdvBehavior_loadLevel(%level)
{
